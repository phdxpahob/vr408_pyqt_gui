...
# Form implementation generated from reading ui file 'vr408mainwindow_nobatt.ui'
#
...
def JointCfg():
    ...
    scfga.combo_hfRight.setCurrentIndex(servoList[1])
    scfga.combo_hrLeft.setCurrentIndex(servoList[2])
    scfga.combo_hrRight.setCurrentIndex(servoList[3])
    scfga.combo_kFLeft.setCurrentIndex(servoList[4])
    scfga.combo_kFRight.setCurrentIndex(servoList[5])
    scfga.combo_kRLeft.setCurrentIndex(servoList[6])
    ...
    if AssignServoDialog.exec_():
        ...
        servoList[1] = scfga.combo_hfRight.currentIndex() 
        servoList[2] = scfga.combo_hrLeft.currentIndex()
        servoList[3] = scfga.combo_hrRight.currentIndex()
        servoList[4] = scfga.combo_kFLeft.currentIndex()
        servoList[5] = scfga.combo_kFRight.currentIndex()
        servoList[6] = scfga.combo_kRLeft.currentIndex()
